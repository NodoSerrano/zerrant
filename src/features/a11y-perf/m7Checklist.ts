...
export const M7_A11Y_PERF_CHECKLIST: ChecklistItem[] = [
  ...
  },
  {
    ...
    area: "a11y",
    surface: "EmptyState · TabBar · EventCard (Inicio events) · SystemStateView icons",
    check: "Decorative Lucide icons are aria-hidden so names come from visible labels",
    status: "pass",
    evidence:
      "EmptyState.a11y.test.tsx · TabBar.a11y.test.tsx · InicioHub.a11y.test.tsx (EventCard) · SystemStateView (aria-hidden icons)",
  },
  {
    id: "a11y-birthday-avatar-alt",
    area: "a11y",
    surface: "Inicio birthday rows",
    check: "Avatar inside named row stays decorative on image and initials/error paths (empty alt)",
    status: "pass",
  ...
  },
  {
    ...
    area: "perf",
    surface: "Avatar",
    check: "Fixed width/height + sizes attribute for sm/md/lg avatars",
    status: "pass",
