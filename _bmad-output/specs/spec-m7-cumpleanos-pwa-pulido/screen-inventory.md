...
| 7.5 · Offline / error | `LYkM4` | `/~offline`, `(app)/error`       | CAP-5, 6 | wifi-off + “Sin conexión” + Reintentar (refresh)                                |
| 7.6 · 404             | `eZRDM` | `not-found`                      | CAP-6    | compass + “Perdiste el rumbo” + “Ir al inicio”                                  |
